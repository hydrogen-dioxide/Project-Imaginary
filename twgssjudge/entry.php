...
<body style="width:100%; height:100%; display: flex; flex-direction: rows; flex-wrap: wrap; center; overflow: hidden;" onload="switch_panel(1);">
    ...
    <div style="margin: 0 auto">
        <div id="logo" style="width: 435px; margin-bottom: 25px; align-items: center; text-align: center;"><img src="/assets/image/logo_alt.png" height="60px" id="logo-light"><img src="/assets/image/logo_alt_dark.png" height="60px" id="logo-dark" style="position: absolute; left: 0;right: 0; margin: auto;"></div>
