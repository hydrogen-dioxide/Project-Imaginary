...
<body>
  ...
  <table>
    ...
    <button onclick="compile_contest(0)"> Compile Problems </button>
    ...
    <script>
      function compile_contest(str){
        ...
        xmlhttp.open("GET", "../../php/compile_contest.php?contestID=" + str);
        xmlhttp.send();
        }
      }
    </script>
  ...
  <div id="invitation" name="invitation">
    ...
    <?php include($_SERVER['DOCUMENT_ROOT'].'/Utility.php'); echo Utility::getUserBlock("1", "Daniel", "..."); ?>
  </div>
  </section>
  </main>
  <!-- User-block -->
