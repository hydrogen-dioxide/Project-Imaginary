...
<body>
  ...
  <h2 class="subheading"> <a href="help.php"> HELP </a> </h2>
	...
	<?php include($_SERVER['DOCUMENT_ROOT']."/php/ProblemClass.php");
    $taskID = $problemID;
    $problem = new Problem();
		...
		$subtask_array		= $problem->subtasks;
		$sample_array		= $problem->samples;
	?>
