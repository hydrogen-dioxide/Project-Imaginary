...
<body>
  ...
  <h2 class="subheading"> <A href="help.html"> HELP </A> </h2>
    ...
    $taskID = "X0000";
		...
		$problemID			= htmlspecialchars($problem['problemID'], ENT_QUOTES);
		$problemName		= htmlspecialchars($problem['problemName'], ENT_QUOTES);
		$timeLimit			= htmlspecialchars($problem['timeLimit'], ENT_QUOTES);
		$memoryLimit		= htmlspecialchars($problem['memoryLimit'], ENT_QUOTES);
		$problemType		= htmlspecialchars($problem['problemType'], ENT_QUOTES);
		$author				= htmlspecialchars($problem['author'], ENT_QUOTES);
		$acceptedLanguages	= json_decode($problem['acceptedLanguages'], true);
		$proposedTime		= htmlspecialchars($problem['proposedTime'], ENT_QUOTES);
		$problemStatement	= htmlspecialchars($problem['problemStatement'], ENT_QUOTES);
	...
	<form action="/php/task_update.php" method="POST">
